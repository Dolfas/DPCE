...
mse = sum((Dy_sim-Dy).^2)/N;
fprintf('MSE between propagated and measured output for the dataset1 is: %.4f\n',mse);
...
fprintf('MSE between propagated and measured output for the dataset2 is: %.4f\n',mse);
